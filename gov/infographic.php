...
<?php
    $pagetitle = 'Infographic | PDP Governors Forum';
    $currentPage = 'infographic';
...
<?php
  ...
  $result = $conn -> query("SELECT * FROM documents WHERE type=3 ORDER BY date DESC");
  $data_table = "";
...
?>
	...
	<div class="page-title" style="background-image: url(assets/img/Blur.jpg);">
		<div class="container">
			<h1 class="title-line-left">Our Infographics</h1>
  ...
  <section class="s-our-team about-team speakers-our-team" style="padding-top: 50px">
    <div class="container">
      <h2 class="title-line" style="margin-bottom: 15px">Our Infographics</h2>
